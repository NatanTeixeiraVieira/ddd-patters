import { EnviaConsoleLogHandler } from '../event/handler/envia-console-log.handler.ts';
import { EnviaConsoleLog1Handler } from '../event/handler/envia-console-log1.handler.ts';
import { EnviaConsoleLog2Handler } from '../event/handler/envia-console-log2.handler.ts';
